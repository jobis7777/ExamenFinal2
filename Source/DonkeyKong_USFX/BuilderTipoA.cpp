...
void ABuilderTipoA::BeginPlay()
{
    ...
    if(GEngine)
	{
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Orange, TEXT("Builder Tipo A"));
	}
}
...
void ABuilderTipoA::ConstruirNivel3(int cantidadPisos, int cantidadPlataformas, FVector ubicacionInicial, int direcionInicial)
{
}
