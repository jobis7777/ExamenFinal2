...
void ABuilderTipoB::BeginPlay()
{
	...
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Orange, TEXT("Builder Tipo B"));
	}
}
...
void ABuilderTipoB::ConstruirNivel3(int cantidadPisos, int cantidadPlataformas, FVector ubicacionInicial, int direcionInicial)
{
}
