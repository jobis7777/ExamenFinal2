...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Constructor3_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Constructor3;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::NewProp_Constructor3_MetaData[] = {
		{ "Category", "GameModeBase" },
		{ "ModuleRelativePath", "DonkeyKong_USFXGameMode.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::NewProp_Constructor3 = { "Constructor3", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADonkeyKong_USFXGameMode, Constructor3), Z_Construct_UClass_ABuilderTipoC_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::NewProp_Constructor3_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::NewProp_Constructor3_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADonkeyKong_USFXGameMode_Statics::NewProp_Constructor3,
	...
	IMPLEMENT_CLASS(ADonkeyKong_USFXGameMode, 3420340458);
